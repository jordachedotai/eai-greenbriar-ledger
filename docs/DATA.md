...
- `data/demo-states.json`: `july`, `august`, `august-approved`, `monday`. Generated by `scripts/gen-states.ts` from the fixtures above. `monday` adds nine one-line fictional companies for the scale beat; they have statuses but no quote stacks.
