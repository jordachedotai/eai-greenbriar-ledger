...
// A demo state: which months have arrived and what follows from that.
// Generated by scripts/gen-states.ts from the fixtures; lib/states.ts
// applies one to the ledger. Everything here is derived, nothing typed.
export type DemoState = {
  name: string; // july, august, august-approved, monday
  label: string; // "July 2026"
  companyIds: string[]; // the companies the state shows, in board order
  months: Month[]; // the months that have arrived
  month: Month; // the last of them: the header toggle and "Where it stands in"
  ...
  questionsApproved: string[]; // company ids whose questions the deal lead has approved
