...
// The company view. Tabs: Initiatives, Current state, Learning log,
// Quarterly prep. The Initiatives tab is three columns: the initiative
// list, the quote stack for the selected one, the questions rail.
// Selection and tab live in the URL. The default selection is the
// worst-flagged initiative as of the month in view. Needs a Suspense
// boundary above it (it reads the URL).
...
import { QuestionsRail } from "./QuestionsRail";
import { CurrentState } from "./CurrentState";
import { LogList } from "./LogList";
import { QuarterlyPrep } from "./QuarterlyPrep";
